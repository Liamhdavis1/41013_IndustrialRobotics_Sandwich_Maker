# @file
# @brief Rough version of Veggie Robot abb_irb_120 defined by standard DH parameters with 3D model
...
if __name__ == "__main__":
    r = abb_irb_120()
    # input("Press Enter to spawn Veggie Robot ABB_irb_120")
    r.traj_then_teach()
